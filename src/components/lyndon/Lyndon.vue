...
.bg-color {
  background-color: rgb(213, 188, 142);
}
.main-pic {
  text-align: center;
}
...
button {
  ...
  padding: 10px 20px;
  border: 2px solid rgb(213, 188, 142);
  border-radius: 100px;
  width: 250px;
  margin: 10px;
}
