...
import OurDesigners from "./components/matt/MattOurDesigners.vue"
import Profile from "./components/matt/MattProfile.vue"
...
const routes = [
  ...
  { path: "/MattOurDesigners", component: OurDesigners, name: "OurDesigners", props: true},
  { path: "/MattProfile", component: Profile, name: "Profile", props: true}
];
